        ...
        public IActionResult Edit(Slider slider)
        {
            if (slider.Nombre != null)
            {
                ...
                if (archivos.Count() > 0)
                {
                    ...
                    var rutaImagen = Path.Combine(rutaPrincipal, sliderDesdeDb.Urllmagen.TrimStart('\\'));
                    ...
                    slider.Urllmagen = @"\imagenes\sliders\" + nombreArchivo + nuevaExtension;
                ...
                else
                {
                    ...
                    slider.Urllmagen = sliderDesdeDb.Urllmagen;
                }
